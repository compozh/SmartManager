  ...
  <div class="parentx">
    <vs-sidebar v-hammer:swipe.left="onSwipeLeft" ref="mainSidebar" :parent="parent"
      ...
      <div @mouseenter="sidebarMouseEntered" @mouseleave="sidebarMouseLeave">
        ...
        <VuePerfectScrollbar ref="mainSidebarPs" class="scroll-area--main-sidebar pt-2"
          ...
          <template v-for="(sidebarItem, index) in sidebarItems">
            ...
            <template v-else-if="!sidebarItem.header">
              ...
              <!-- IF IT'S SINGLE ITEM -->
              <vx-sidebar-item ref="sidebarLink" :key="`sidebarItem-${index}`"
                               v-if="!sidebarItem.submenu" :index="index"
                               ...
                               :isDisabled="sidebarItem.isDisabled" :slug="sidebarItem.slug">

                <vx-tooltip delay="0.5s" position="right"
                            :text=" $t(sidebarItem.i18n) || sidebarItem.name ">
              ...
              <template v-else>
                <vx-sidebar-group ref="sidebarGrp" :key="`group-${index}`"
                                  :openHover="openGroupHover" :group="sidebarItem"
                                  :groupIndex="index"
