                            ...
                            <div class="p-8">
                                ...
                                <div class="social-login flex flex-wrap justify-between">
                                    <div class="social-login-buttons flex flex-wrap items-center mt-4">
                                        ...
                                        <!-- facebook -->
                                        <div v-if="facebookAllowed" class="bg-facebook pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4" @click="loginWithFacebook">
                                        ...
                                        <!-- TWITTER -->
                                        <div v-if="twitterAllowed" class="bg-twitter pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4" @click="loginWithTwitter">
                                        ...
                                        <!-- GOOGLE -->
                                        <div v-if="googleAllowed" class="bg-google pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4" @click="loginWithGoogle">
                                        ...
                                        <!-- GITHUB -->
                                        <div v-if="githubAllowed" class="bg-github pt-3 pb-2 px-4 rounded-lg cursor-pointer mr-4" @click="loginWithGithub">
...
export default {
  ...
  computed: {
    ...
    googleAllowed() { return this.config.allowedAlternativeLoginMethods.includes('google') },
    twitterAllowed() { return this.config.allowedAlternativeLoginMethods.includes('twitter') },
    githubAllowed() { return this.config.allowedAlternativeLoginMethods.includes('github') }
  },
  methods: {
    loginMethod() {
