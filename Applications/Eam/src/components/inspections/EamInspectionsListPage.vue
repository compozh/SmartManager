...
<script>
import allInspections from '@/api/inspections/allInspections.gql'
import allInspectionsByEquipment from '@/api/inspections/allInspectionsByEquipment.gql'
