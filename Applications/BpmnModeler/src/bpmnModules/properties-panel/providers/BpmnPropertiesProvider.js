...
import { GeneralTab, FormsTab, BusinessObjectAccessTab, ListenersTab } from '../bpmn/parts/tabs';
...
export default class BpmnPropertiesProvider {
  ...
  getTabs(element) {
    ...
    tabs.push(new ListenersTab(this.diagram, element, entryFactory, bpmnFactory, commandStack, elementRegistry, translate));
