...
import extensionsElementHelper from 'bpmn-js-properties-panel/lib/helper/ExtensionElementsHelper';


export class  ImplementationTypeHelper {
  constructor() {
  }
  /**
   * Returns 'true' if the given element is 'ServiceTaskLike'
   *
   * @param {djs.model.Base} element
   *
   * @return {boolean} a boolean value
   */
  static isServiceTaskLike(element) {
    return is(element, 'camunda:ServiceTaskLike') || is(element, 'IT-Enterprise:ServiceTaskLike');
  }
  /**
   ...
   * @return {boolean} a boolean value
   */
  static isExternalCapable(element) {
    return is(element, 'camunda:ExternalCapable') || is(element, 'IT-Enterprise:ExternalCapable');
  }
  /**
   ...
   * @return {boolean} a boolean value
   */
  static isExecutionListener(element) {
   ...
   */
  static getServiceTaskLikeBusinessObject(element) {
   ...
   */
  static getImplementationType(element) {
