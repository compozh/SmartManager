  ...
  methods: {
    ...
    itemChange(ev) {
      ...
      mutation {
        _ordersMutation
        {
          orderItem(operation:UPDATE, orderItem: {orderId:${this.order.id}, itemId:${
  ev.item.id
}, count:${ev.count} }) {
            count
          }
    ...
    onAddApprove() {
      ...
      mutation {
        _ordersMutation
        {
          orderItem(operation:ADD, orderItem: {orderId:${this.order.id}, itemId:${
  this.itemToAdd.item.id
}, count:${this.itemToAdd.count} }) {
            count
          }
        }
      }`
    ...
    deleteItem(item) {
      ...
      mutation {
        _ordersMutation
        {
          orderItem(operation:DELETE, orderItem: {orderId:${this.order.id}, itemId:${
  item.item.id
}, count:${item.count} }) {
            count
          }
