...
namespace ItGraphQlSchema.Types.EamSchema
{
	...
	public class EquipmentTypeGraph: EfObjectGraphType<CommonDbContext, EquipmentType>
	{
		public EquipmentTypeGraph(IEfGraphQLService<CommonDbContext> graphQlService) :
			base(graphQlService)
		{
