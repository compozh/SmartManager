...
namespace ItGraphQlSchema.Types.EamSchema.GraphTypes
{
	...
	public class ConditionParameterAdditionalDataGraph: EfObjectGraphType<ConditionParameterAdditionalData>
	{
			...
			base(graphQlService)
		{
			...
			AddNavigationField(
				name: "responsible",
				resolve: context => context.Source.Responsible);
			AddNavigationField(
				name: "sourceTechPlace",
				resolve: context => context.Source.SourceTechPlace);
			AddNavigationField(
				name: "failureType",
				resolve: context => context.Source.FailureType);
			AddNavigationField(
				name: "failureReason",
				resolve: context => context.Source.FailureReason);
			AddNavigationField(
				name: "direction",
