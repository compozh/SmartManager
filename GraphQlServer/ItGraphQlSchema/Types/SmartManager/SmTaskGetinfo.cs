...
namespace ItGraphQlSchema.Types.SmartManager
{
	public class SmTaskGetinfo
	{
		...
		public List<SmTaskGetinfoNestedParticipants> Participants { get; set; }
		[JsonProperty("doc_responsibletext")]
		public string DocResponsibleText { get; set; }
		[JsonProperty("Originals")]
		public List <SmTaskGetinfoNestedOriginals> Originals { get; set; }
		[JsonProperty("comments")]
		public List<SmTaskGetinfoNestedComments> Comments { get; set; }
		//[JsonProperty("tasks")]
		//public string Tasks { get; set; }

	}

	public class SmTaskGetinfoNestedParticipants
	{
		//[JsonProperty("userid")]
	...
	public class SmTaskGetinfoNestedOriginals 
	{
		[JsonProperty("Id")]
		public int  Id { get; set; }
		[JsonProperty("ndor")]
	...
	public class SmTaskGetinfoNestedComments
	{
		public string User { get; set; }
		public DateTime Date { get; set; }
