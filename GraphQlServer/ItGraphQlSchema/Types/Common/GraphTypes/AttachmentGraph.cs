...
namespace ItGraphQlSchema.Types.Common
{
	...
	public class AttachmentGraph: EfObjectGraphType<CommonDbContext, Attachment>
	{
		public AttachmentGraph(IEfGraphQLService<CommonDbContext> graphQlService, IAttachmentsProvider attachmentsProvider) :
			base(graphQlService)
		{
